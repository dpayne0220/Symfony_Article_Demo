...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/css/3aeefd4')) {
            // _assetic_3aeefd4
            if ($pathinfo === '/css/3aeefd4.css') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '3aeefd4',  'pos' => NULL,  '_format' => 'css',  '_route' => '_assetic_3aeefd4',);
            }

            // _assetic_3aeefd4_0
            if ($pathinfo === '/css/3aeefd4_part_1_styles_1.css') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '3aeefd4',  'pos' => 0,  '_format' => 'css',  '_route' => '_assetic_3aeefd4_0',);
            }
